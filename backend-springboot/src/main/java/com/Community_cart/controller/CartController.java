...
import com.Community_cart.service.CartSerive;
...
public class CartController {
	...
	public ResponseEntity<CartItem> addItemToCart(@RequestBody AddCartItemRequest req,
			@RequestHeader("Authorization") String jwt) throws UserException, ProductException, CartException, CartItemException {
