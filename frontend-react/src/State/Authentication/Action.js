...
export const loginUser = (reqData) => async (dispatch) => {
  try {
    ...
    if(data.role==="ROLE_SHOP_OWNER"){
      ...
      // Add your logic for ROLE_ADMIN here
...
export const addToFavorites = ({shopId,jwt}) => {
  return async (dispatch) => {
    dispatch({ type: ADD_TO_FAVORITES_REQUEST });
    try {
      const { data } = await api.put(`api/shops/${shopId}/add-favorites`,{},{
        headers: {
