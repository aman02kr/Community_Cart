...
import {
  fetchShopsOrder,
  updateOrderStatus,
} from "../../State/Admin/Order/shops.order.action";
// import {
//   confirmOrder,
//   deleteOrder,
//   deliveredOrder,
...
const OrdersTable = ({ isDashboard, name }) => {
  ...
  const { shopsOrder } = useSelector((store) => store);
  ...
  // console.log("shops orders store ", shopsOrder)
      ...
      <Card className="mt-1">
        ...
        <TableContainer>
          <Table sx={{}} aria-label="table in dashboard">
            ...
            <TableBody>
              {shopsOrder.orders
                ?.slice(0, isDashboard ? 7 : shopsOrder.orders.length)
                .map((item, index) => (
                  <TableRow
